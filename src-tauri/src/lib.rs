...
use commands::fs::{
    ...
    delete_to_trash, exists, get_disk_free, get_entries, get_home_dir, get_parent_dir, move_file,
    open_file, open_in_terminal, open_url, read_image_base64, read_text_file, rename,
};
